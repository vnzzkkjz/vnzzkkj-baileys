...
const al_e_dev_version_json_1 = require("../Defaults/al-e-dev-version.json");
...
const generateMessageID = () => 'DEVS' + (0, crypto_1.randomBytes)(18).toString('hex').toUpperCase();
...
const printQRIfNecessaryListener = (ev, logger) => {
    ev.on('connection.update', async ({ qr }) => {
        if (qr) {
            if (qrcode_terminal_1.default) {
                qrcode_terminal_1.default === null || qrcode_terminal_1.default === void 0 ? void 0 : qrcode_terminal_1.default.generate(qr, { small: true });
            }
            else {
...
const fetchLatestBaileysVersion = async (options = {}) => {
    ...
    try {
        ...
        return {
            version: al_e_dev_version_json_1.version,
            isLatest: false,
            error
        };
    }
