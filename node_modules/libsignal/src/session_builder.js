...
class SessionBuilder {
    ...
    async initOutgoing(device) {
        ...
        return await queueJob(fqAddr, async () => {
            ...
            if (!record) {
                ...
                if (openSession) {
                    // no puta : console.warn("Closing stale open session for new outgoing prekey bundle");
    ...
    async initIncoming(record, message) {
        ...
        if (existingOpenSession) {
            // me llegas a la cola : console.warn("Closing open session in favor of incoming prekey bundle");
